...
public class AddVolunteer extends javax.swing.JFrame {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        // TODO add your handling code here:
        String volunteername=this.Name.getText();
        String volunteercnic=this.CNIC.getText();
        
        String volunteerphonenumber=this.phone.getText();
        String volunteeraddress=this.address.getText();
        int age=Integer.parseInt(this.age.getText());
        String volunteeremail=this.email.getText();
        Volunteer v=new Volunteer(volunteername,volunteercnic,volunteeraddress,volunteeremail,age,volunteerphonenumber);
